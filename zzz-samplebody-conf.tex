...
\appendix
%Appendix A
\section{Interview instrument questions}

\begin{enumerate}
\item What is your age, please?
\item What is your identified gender?
\item Can you please tell me a little bit about your professional experience with security issues (training, work domains, research, etc.)?
...
\item What mobile devices (i.e. smartphones, laptops, tablets, wearables, etc.) do you currently use (for each item, describe its make, how long it has been owned, unlocking method, interval between acquisition and BAM use, and duration of BAM use)?
...
\item Do you have any concerns about re-sale or compromise of your biometric data, or no?
...
\item Which method do you think of as the primary way of unlocking the phone?
...
\item Please recall an example of when you learned something new about biometric authentication—this could be a story you heard directly, an academic publication, or news item.
\begin{itemize}
\item What was it about?
\item What was the source, and medium (article, conversation, etc.)?
\item About how long ago did you hear this information?
\item Do you remember where you heard this
\item What kind of format was the information in (i.e. story, policy, advice)?
\item Was the information positive, negative, or neutral regarding biometrics?
\item Did you think it was true?
\item Was the information portrayed in an intense or sensationalistic way, or not?
\item Was the information portrayal of biometrics figurative or literal?
\end{itemize}
\end{enumerate}
